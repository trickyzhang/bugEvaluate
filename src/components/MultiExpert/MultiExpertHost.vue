...
<script>
import { Button, Row, Col, Card, Form, Input, Radio, Select, DatePicker, Modal, message, Avatar, Tag, Icon, Empty, Spin, Table } from 'ant-design-vue';
...
export default {
    ...
    components: {
        ...
        'a-radio-group': Radio.Group, 'a-radio-button': Radio.Button,'a-table':Table,
        ...
        async connectToVoiceWithToken(token) {
            ...
            try {
                ...
                if (error.name === 'NotAllowedError' || error.name === 'PermissionDeniedError') {
                    ...
                    this.$confirm({
                        title: '麦克风权限被拒绝',
                        content: `<div style="text-align: left;"><p><strong>解决方法：</strong></p><p>1. 点击浏览器地址栏左侧的锁定图标</p><p>2. 找到"麦克风"选项，选择"允许"</p><p>3. 刷新页面后重新尝试连接语音</p></div>`,
